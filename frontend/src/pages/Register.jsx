...
import { Heart, User, Mail, Lock, ArrowRight, Eye, EyeOff, Sparkles } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:col-span-7 relative overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 flex-col justify-between p-12 text-white">
        ...
        <div className="relative z-10 my-auto max-w-lg">
          <h1 className="text-5xl font-extrabold leading-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-pink-100 to-indigo-100">
            Create your dream wedding workspace.
          </h1>
          <p className="text-lg text-purple-100/80 mb-8 leading-relaxed">
            Join thousands of couples planning their special day. Streamline your budget, synchronize tasks, and manage vendors instantly.
          </p>
          
          <div className="space-y-4">
            <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md p-4 rounded-xl border border-white/10">
              <div className="w-8 h-8 rounded-lg bg-pink-500/20 flex items-center justify-center text-pink-300">🎉</div>
              <div>
                <p className="font-semibold text-sm">Interactive Guest Lists</p>
                <p className="text-xs text-purple-200/60">Invite family members, assign roles, manage dietary requirements, and track RSVPs.</p>
              </div>
            </div>
            <div className="flex items-center gap-3 bg-white/5 backdrop-blur-md p-4 rounded-xl border border-white/10">
              <div className="w-8 h-8 rounded-lg bg-indigo-500/20 flex items-center justify-center text-indigo-300">📅</div>
              <div>
                <p className="font-semibold text-sm">Milestone Timelines</p>
                <p className="text-xs text-purple-200/60">Organize and coordinate events, timelines, and vendor bookings seamlessly.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
              Start setting up your personal wedding workspace today.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-xl rounded-2xl p-8 space-y-6">
            ...
            <form onSubmit={submitHandler} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-gray-600 dark:text-gray-300 block" htmlFor="name">
                  Your Full Name
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary dark:text-white transition-all text-sm"
                    value={name}
              ...
              {/* Password Input */}
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-gray-600 dark:text-gray-300 block" htmlFor="password">
                  Password
                </label>
                <div className="relative">
                  <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center text-gray-400">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full pl-10 pr-10 py-2.5 bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary dark:text-white transition-all text-sm"
                    value={password}
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-primary to-purple-800 hover:from-purple-800 hover:to-indigo-900 text-white font-bold rounded-xl transition duration-300 shadow-lg shadow-purple-600/10 cursor-pointer disabled:opacity-50 mt-2"
              >
                {isLoading ? (
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2.5 bg-gradient-to-r from-pink-500 to-rose-600 hover:from-rose-600 hover:to-pink-700 text-white font-bold rounded-xl transition duration-300 shadow-md shadow-pink-500/10 cursor-pointer"
            >
              <Sparkles size={16} />
              Explore Demo Mode (No Account)
            </button>

            {/* Login Link */}
            <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-4">
              Already have a wedding workspace?{' '}
